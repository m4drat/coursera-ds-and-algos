...
std::vector gDenominations { 1, 3, 4 };
...
bool CheckSolution() {
    ...
    std::vector<ProblemStatement> problemSolutionPairs {
        ProblemStatement{ .denominations{ 1, 3, 4 }, .money = 2 , .answer = 2, .name{ "1 - testcase" } },
        ProblemStatement{ .denominations{ 1, 3, 4 }, .money = 34 , .answer = 9, .name{ "2 - testcase" } },
        ProblemStatement{ .denominations{ 1, 3, 4 }, .money = 17 , .answer = 5, .name{ "3 - testcase" } },
        ProblemStatement{ .denominations{ 1, 3, 4 }, .money = 9 , .answer = 3, .name{ "4 - testcase" } },
        ProblemStatement{ .denominations{ 1, 3, 4 }, .money = 43 , .answer = 11, .name{ "5 - testcase" } },
    };
