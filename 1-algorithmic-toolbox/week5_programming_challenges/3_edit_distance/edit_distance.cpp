...
int32_t EditDistance(const std::string& str1, const std::string& str2) {
    std::vector<std::vector<int32_t>> dpMat(
        str1.length() + 1, 
...
bool CheckSolution() {
    ...
    std::vector<ProblemStatement> problemSolutionPairs {
        ...
        ProblemStatement{ .str1{ "short" }, .str2{ "ports" }, .answer = 3, .name{ "2 - testcase" } },
        ProblemStatement{ .str1{ "editing" }, .str2{ "distance" }, .answer = 5, .name{ "3 - testcase" } },
        ProblemStatement{ .str1{ "cat" }, .str2{ "cut" }, .answer = 1, .name{ "4 - testcase" } },
        ProblemStatement{ .str1{ "sunday" }, .str2{ "saturday" }, .answer = 3, .name{ "5 - testcase" } },
        ProblemStatement{ .str1{ "ATGTTATA" }, .str2{ "ATCGTCC" }, .answer = 5, .name{ "6 - testcase" } },
        ProblemStatement{ 
            .str1{ "aacudfoennnndpperdsdpernskfytskkjjjfornthshgf" }, 
            .str2{ "ssacudfoenndpeeprerdsddnskfytskkjjjfoppthsggf" }, 
            .answer = 13, 
            .name{ "7 - testcase" }
        },
        ProblemStatement{ 
            .str1{ "aacudfoennnndpperdsdpernskfytskkjjjforntdkihkjhkaysduiasydhshgfasudaiuyasdadiuastdgjbegjuagsjhdasd" }, 
            .str2{ "sdeudfoenfffdpperdsweernskfytskkjjjforntdkihkjhkasydhshgfasudasdjfgwhghjqyasdadiuastdgjbegjuagsjdjihsgjdwsd" }, 
            .answer = 32, 
            .name{ "8 - testcase" }
        }
    };
