...
void CheckSolution() {
    ...
    std::vector<ProblemStatement> problemSolutionPairs {
        ...
        ProblemStatement{ .segments = { {1, 5}, {2, 7}, {3, 5}, {4, 5}, {8, 10} }, .answer{ 5, 10 }},
        ProblemStatement{ .segments = { {1, 1}, {2, 2}, {2, 3}, {3, 4}, {4, 4} }, .answer{ 1, 2, 4 }},
        ProblemStatement{ .segments = { {0, 0}, {0, 1}, {0, 2}, {2, 3}, {3, 5}, {5, 6}, {5, 7} }, .answer{ 0, 3, 6 }},
    };
