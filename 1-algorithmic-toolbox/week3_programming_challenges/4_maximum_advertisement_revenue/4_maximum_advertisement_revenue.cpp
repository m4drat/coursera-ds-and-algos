...
void CheckSolution() {
    ...
    std::vector<ProblemStatement> problemSolutionPairs {
        ...
        ProblemStatement{ .firstSequence = { 1, 3, -5 }, .secondSequence{ -2, 4, 1 }, .answer{ 23 }},
        ProblemStatement{ .firstSequence = { 1 }, .secondSequence{ -2, -1 }, .answer{ -1 }},
        ProblemStatement{ .firstSequence = { 4, 0, 3, -7, -1, -5 }, .secondSequence{ 7, -1 }, .answer{ 28 }},
    };

    for (auto& testcase : problemSolutionPairs) {
        std::sort(testcase.firstSequence.begin(), testcase.firstSequence.end(), std::less<int32_t>());
        std::sort(testcase.secondSequence.begin(), testcase.secondSequence.end(), std::less<int32_t>());
...
int main() {
    ...
    std::sort(profitPerClick.begin(), profitPerClick.end(), std::less<int32_t>());
    std::sort(numberOfClicks.begin(), numberOfClicks.end(), std::less<int32_t>());
